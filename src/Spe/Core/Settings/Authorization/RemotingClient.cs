...
{
    /// <summary>
    /// Represents an SPE Remoting Client item from the content tree.
    /// A client binds a credential (shared secret in v1; OAuth client id in a
    /// later phase) to a remoting policy, optional user impersonation, and
    /// request throttling.
    /// </summary>
