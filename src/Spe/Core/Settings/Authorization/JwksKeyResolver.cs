...
namespace Spe.Core.Settings.Authorization
{
    internal static class JwksKeyResolver
    {
        ...
        public static JsonWebKey GetKey(string jwksUri, string kid, int cacheSeconds)
        {
            ...
            entry = Refresh(jwksUri, cacheSeconds);
        ...
        private static CacheEntry Refresh(string jwksUri, int cacheSeconds)
        {
            try
            {
