...
{
    [Cmdlet(VerbsCommon.New, "User", DefaultParameterSetName = "Id")]
    ...
    public class NewUserCommand : BaseCommand
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (User.Exists(name))
            {
                ...
                WriteError(new ErrorRecord(new DuplicateNameException(error), error, ErrorCategory.InvalidArgument, Identity));
                return;
            }
