...
# ============================================================================
#  Test Group 7: Max Token Lifetime Enforcement (maxTokenLifetimeSeconds=300)
# ============================================================================
Write-Host "`n  [Test Group 7: Max Token Lifetime Enforcement]" -ForegroundColor White
...
# 7a. Token with short lifetime (30s, default) and iat -- should pass
...
# 7b. Token with lifetime at the limit (300s) and iat -- should pass
$token = New-Jwt -Algorithm HS256 -Issuer "SPE Remoting" -Audience $protocolHost `
...
# 7c. Token with excessive lifetime (3600s) and iat -- should be rejected
$token = New-Jwt -Algorithm HS256 -Issuer "SPE Remoting" -Audience $protocolHost `
...
# 7d. Token with excessive lifetime but NO iat -- should pass (iat required for enforcement)
$token = New-Jwt -Algorithm HS256 -Issuer "SPE Remoting" -Audience $protocolHost `
